...
export default function NavBar() {
  return (
    <div className="w-full px-20 py-3 fixed top-0 left-0 flex items-center bg-indigo-950 z-10 backdrop-blur-sm">
      <Link href="/" className="flex items-center flex-grow">
        <img src="/logo/logo-white-text.png" alt="logo" className="w-40" />
      </Link>
