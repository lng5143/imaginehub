  ...
  return (
    <div className="w-full px-10 md:px-20 py-3 fixed top-0 left-0 flex items-center bg-indigo-950 z-10 backdrop-blur-sm">
      ...
      <div className="flex gap-5 items-center">
        <Button asChild variant="ghost" className="text-white hover:bg-amber-500 hover:text-slate-950 hover:scale-105 transition-all duration-300">
        ...
        <Button asChild className="bg-white text-indigo-950 hover:bg-amber-500 hover:scale-105 transition-all duration-300">
