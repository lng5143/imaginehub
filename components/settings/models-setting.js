import { saveAPIKeys } from '@/lib/models';

export default function ModelsSetting() {
    const handleSaveAPIKeys = (APIkey, provider) => {
        debugger
        saveAPIKeys(APIkey, provider);
    };
        ...
        <div>
            ...
            <div className="space-y-4">
                <div>
                    ...
                    <button className="bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-4 rounded-md mt-2" 
                        onClick={() => handleSaveAPIKeys(document.getElementById('openai-api-key').value, 'openai')}>Save</button>
                </div>
                <div>
                    ...
                    <button className="bg-blue-500 hover:bg-blue-600 text-white font-medium py-2 px-4 rounded-md mt-2" 
                        onClick={() => handleSaveAPIKeys(document.getElementById('stability-api-key').value, 'stabilityai')}>Save</button>
                </div>
            </div>
        </div>
    )
