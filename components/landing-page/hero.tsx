...
export default function HeroSection() {
    return (
        <div className="bg-[url('/hero-bg.jpg')] flex flex-col lg:flex-row lg:gap-12 items-center bg-cover bg-center bg-no-repeat w-full">
            <div className="flex flex-col gap-10 pl-10 md:pl-28 py-40 basis-1/3">
                <h1 className="text-5xl font-bold w-full">
                    Simple user interface to use your favorite image generation model
                </h1>
            ...
            <div className="hidden lg:block pr-20 py-20 lg:py-40 lg:pr-28 basis-2/3">
